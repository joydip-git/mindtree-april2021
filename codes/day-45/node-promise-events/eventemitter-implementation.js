...
calcEventEmitter.on('start',
    (startMessage) => console.log(startMessage)
)
calcEventEmitter.on('end',
    (errorMessage) => console.log(errorMessage)
)
calcEventEmitter.on('error',
    (endMessage) => console.log(endMessage)
)

// function calculate(operation, ...args) {
function calculate(...args) {
    const operations = [addNumbers, subtractNumbers, divideNumbers]
